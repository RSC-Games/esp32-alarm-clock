...
from ucrypto.contextlib import contextmanager
...
class Encoder(object):
    ...
    def enter(self, nr, cls=None):  # type: (int, int | None) -> None
    ...
    @contextmanager
    def construct(self, nr, cls=None):  # type: (int, int | None) -> Any
    ...
    def write(self, value, nr=None, typ=None, cls=None):  # type: (object, int | None, int | None, int | None) -> None
...
class Decoder(object):
    ...
    def read(self, tagnr=None):  # type: (int) -> tuple(Tag, any)
